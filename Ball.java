...
class Ball {
    ...
    // GM error checking
    void putBallBackInPlay (String direction) {

        switch (direction) {
            case "bottom":

                mRect.top = mRect.top - mBallHeight;
                mYVelocity = -abs(mYVelocity);
            ...
            case "left":
                ...
                mRect.left = mRect.left + mBallWidth;
                mXVelocity = abs(mXVelocity);
    ...
    void increaseVelocity(){
        // increase the speed by 5%   (GM changed from 10%)
    ...
    void decreaseVelocity() {
        mXVelocity = mXVelocity * 0.5f;
        mYVelocity = mYVelocity * 0.5f;
    }
